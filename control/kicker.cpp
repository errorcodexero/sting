...
Kicker::Estimator::Estimator():last(kicker::Status_detail::error()){}
...
Robot_outputs Kicker::Output_applicator::operator()(Robot_outputs robot,Lift::Output kicker)const{
	if(kicker==Kicker::Output::IN) robot.solenoid[kicker_address].power_level=kicker;
	else if(kicker==Kicker::Output::OUT) robot.solenoid[kicker_address].power_level=kicker;
	return robot;
}

Kicker::Output Kicker::Output_applicator::operator()(Robot_outputs in)const{
	return in.solenoid[kicker_address].power_level;
}
...
bool operator<(Kicker::Input const& a,Kicker::Input const& b){
	return 0;
}
...
Kicker::Status_detail::Status_detail(){}

Kicker::Goal::Goal(){}
/*
Kicker::Status_detail::Type Kicker::Status_detail()const{ return type_; }
